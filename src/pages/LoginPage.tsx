...
import { Mail, Lock, Sparkles, Eye, EyeOff, Zap, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-black text-foreground">Welcome back</h1>
          <p className="mt-1.5 text-sm text-muted-foreground">Sign in to your creator account</p>
        </div>
